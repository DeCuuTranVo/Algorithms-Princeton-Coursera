...
public class BoggleGame extends JFrame {
    ...
    public BoggleGame(int rows, int cols) {
        ...
        // creates the board and the list that will show all the available words at the
        // end of a game
        bp = new BoardPanel();
    ...
    /**
     * Start a new game, can be called via the menu selection, the button, or CMD+N
     * (CRTL+N).
     */
    ...
    /**
     * End the current game, can be called via the menu selection, the button, or
     * CMD+E (CRTL+E).
     */
    ...
    private class BoardPanel extends JPanel {
         ...
         * @param pathIndex Current number of cubes searched (only differs from curChar
         *                  if there is a q in string)
